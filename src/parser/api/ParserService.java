...
/***
 * 1) ArrayList<String> parseArrList(ArrayList<String> arrayList) принимает ArrayList<String>,
 ...
 * 5) Возвращаем ArrayList<String> выражений с цифрами и операциями, которые разделены символом ©
 * Примеры работы:
 * Входящий ArrayList:
 * 22 *(1123 + 33*44    -   11);
 * Получаемый массив:
 ...
 * 2) Разбивает на токены используя, список токенов перечислен в Tokens, Enumы операций, цифр и скобок.
 ...
 * Когда доходим до массива с ; там один [;] и всё ок, добавляем его как токен EOL
 *
...
{
    ArrayList<String> parseArrList(ArrayList<String> arrayList);
    String[][] parseToTokens(ArrayList<String> listOfTokens);
}
